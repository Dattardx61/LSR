...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "*🔆 WELCOME TO VIP INFERNO DDOS BOT 🔆*", reply_markup=markup, parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "Buy Access! 💰":
        bot.reply_to(message, "* 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦 𝗣𝗥𝗜𝗖𝗘\n\n[𝗣𝗿𝗲𝗺𝗶𝘂𝗺]\n> DAY - 200 INR\n> WEEK - 700 INR\n\n[𝗣𝗹𝗮𝘁𝗶𝗻𝘂𝗺]\n> MONTH - 1600 INR\n\nDM TO BUY @InFeRnODeViL9080 *", parse_mode='Markdown')
